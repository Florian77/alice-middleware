...
const storeAggregates = async (invokeKey, resultData) => {
    ...
    // TODO: refactor don't search for invoke command if  typeConfig.createInvokeCommand === false
    if (resultData && resultData.length > 0) {
        ...
        if (!findInvokeCommandResult && invokeTypeConfig &&  (invokeTypeConfig.invokeCommand === true || invokeTypeConfig.createInvokeCommand === true)) {
